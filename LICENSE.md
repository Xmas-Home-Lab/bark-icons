...
本仓库的机器状态图标修改自 480 Design 的 Solar Icon Set：

- 项目：https://github.com/480-Design/Solar-Icon-Set
- 原始图标：`server-square-bold-duotone`
- 原始许可：Creative Commons Attribution 4.0 International
- 许可全文：https://creativecommons.org/licenses/by/4.0/legalcode

修改内容包括颜色、圆形背景、尺寸安全边距以及信息、故障和恢复状态徽标。

本仓库中的衍生图标同样依据 CC BY 4.0 提供。使用或再分发时请保留上述归属信息。
